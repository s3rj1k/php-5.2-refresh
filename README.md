## php-debian-refresh, branch PHP-5.3

This repository branch provides PHP-5.3.29 debianized sources patched to be build on Debian 8.x "Jessie" and 9.x "Stretch".
